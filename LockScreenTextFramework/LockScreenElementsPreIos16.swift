//
//  LockScreenElementsPreIos16.swift
//  LockScreenTextFramework
//
//  Legacy layout geometry for iOS versions 12-15.
//
...
public struct LockScreenElementsPreIos16: LockScreenElementsProtocol {

    var timeBaseline: CGFloat = 0
    var dateBaseline: CGFloat = 0
    var footerBaseline: CGFloat = 0

    var hasFooterText: Bool
    var hasFooterIcons: Bool
    ...
    public func timeText(at date: Date, locale: Locale?) -> String {
    ...
    public func dateText(at date: Date, locale: Locale?) -> String {
